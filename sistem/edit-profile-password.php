  ...
  <h4>Edit Password</h4> 
    <div class="mx-50 mx-auto ">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="inputMessage"><b>Password</label>
                <input type="" name="password" class="form-control" required value="<?php echo $data2['password'];?>">
            </div>  
    ...
    $row=mysqli_fetch_array($q2);
      if(isset($_POST['kirim'])){
       ...
       $password=$_POST['password'];
        $kirim          =  " UPDATE user 
        SET id_user='$id_user' WHERE id_user='$id_user'";
        $query            = mysqli_query($koneksi, $kirim); 
       
header("location:../page/logout?pesan=update");
